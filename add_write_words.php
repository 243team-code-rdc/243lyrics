...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
            <form class="login100-form validate-form" method="post" action="info/add_paroles_write.php">
					<span class="login100-form-title p-b-33">
						Completer information paroles
					</span>
                ...
                <label>Ecrire vos paroles ici</label>

                <div class="wrap-input100 validate-input">
                    <textarea class="input100" rows="20" placeholder="ecrire vos paroles ici" name="paroles">
